    ...
    final planetCardContent = new Container(
      ...
      child: new Column(
        ...
        children: < Widget > [
          ...
          new Text('Seven Day Outlook', style: headerTextStyle),
          new Container(height: 10.0),
          new Text('Light snow (< 1 cm.) on Sunday, with high temperatures rising to 9°C on Wednesday.', style: subHeaderTextStyle),
          new Container(
